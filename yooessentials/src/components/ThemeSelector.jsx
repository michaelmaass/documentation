...
export function ThemeSelector(props) {
  ...
  return (
    ...
    >
      ...
      >
        <LightIcon className="hidden h-5 w-5 fill-[#febfca] [[data-theme=light]_&]:block" />
        <DarkIcon className="hidden h-5 w-5 fill-slate-400 hover:fill-slate-300 [[data-theme=dark]_&]:block" />
        <LightIcon className="hidden h-5 w-5 fill-[#febfca] [:not(.dark)[data-theme=system]_&]:block" />
        <DarkIcon className="hidden h-5 w-5 fill-slate-400 [.dark[data-theme=system]_&]:block" />
      </Listbox.Button>
